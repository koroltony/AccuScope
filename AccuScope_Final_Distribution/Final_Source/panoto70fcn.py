...
def repeated_region_numpy(frame):
    ...
    ''' Change center based on console footage position
        For example, if there is a nano scope, we need to
        shift the center to be around the left side of the screen
    '''
    center = img.shape[1] // 2
    region_avg = np.mean(img[20:400, center - 40:center + 40], axis=1)
